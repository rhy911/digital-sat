<x-layouts.admin title="Test Dashboard">
    ...
    <div data-test-builder-shell class="test-builder-shell flex bg-[#f6f8fb] text-[#0f172a] relative font-sans"
        ...
        <aside
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-5" id="dashboardTabs" role="tablist"
                ...
                <button
                    ...
                    title="Easy Builder">
                    <i class="bi bi-pencil-square text-lg"></i><span class="test-builder-sidebar-label">Easy Builder</span>
                </button>
        ...
        <main class="test-builder-main flex-1 flex flex-col bg-[#f6f8fb]">
            ...
            <header class="test-builder-header flex justify-between items-center gap-4 border-b border-[#e2e8f0] z-10 bg-white text-[#0f172a]">
                <div class="flex min-w-0 items-center">
                    ...
                    <div class="min-w-0">
                        <p class="text-xs font-semibold text-slate-500">Content Suite</p>
                        <h1 id="dashboard-active-title" class="truncate text-lg font-extrabold tracking-tight text-slate-900">Practice Tests</h1>
                        <p id="dashboard-active-description" class="hidden truncate text-xs font-medium text-slate-600 md:block">Create and manage SAT practice tests.</p>
                    </div>
                </div>
                @auth
                    <div class="flex items-center gap-2 shrink-0 sm:gap-3">
                        <button type="button"
                            ...
                            <i class="bi bi-plus-lg text-xs" aria-hidden="true"></i><span class="hidden sm:inline">Create test</span>
                        </button>
