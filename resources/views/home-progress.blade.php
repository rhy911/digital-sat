<x-layouts.app-progress :user="$user">
    @push('styles')
        @vite(['resources/css/home-progress.css'])
    @endpush
    ...
    <div class="ds-home">
        <section class="ds-workspace-head" aria-labelledby="progress-title">
            ...
            <div class="ds-workspace-actions" aria-label="Primary progress actions">
                ...
                @if($primaryInProgress && $resumeModuleUlid)
                    <a href="{{ route('take-test', ['ulid' => $resumeModuleUlid]) }}?attempt={{ $primaryInProgress->ulid }}" class="ds-button ds-button--secondary">
                        Resume practice
                    </a>
                @else
        ...
        <section class="ds-command-grid" aria-label="Personal practice command center">
            ...
            <article class="ds-card" aria-labelledby="section-split-title">
        ...
        <section class="ds-dashboard-grid">
            <article class="ds-card ds-trend-card" aria-labelledby="trend-title">
                ...
                @if($history->isNotEmpty())
                    <div class="ds-trend-bars" aria-label="Last {{ $history->count() }} completed test scores">
            ...
            <article class="ds-card" aria-labelledby="active-work-title">
                ...
                @forelse($inProgressTests as $attempt)
                    ...
                    <div class="ds-attempt-row">
                        ...
                        @if($moduleUlid)
                            <a href="{{ route('take-test', ['ulid' => $moduleUlid]) }}?attempt={{ $attempt->ulid }}" class="ds-link">Resume</a>
                        @else
