<x-layouts.admin title="Test Dashboard">
    ...
    <style>
        .tom-select { height: auto !important; }
        ...
        .editor-toolbar { border-color: #dee2e6; border-radius: 0.375rem 0.375rem 0 0; }
        .CodeMirror { border-color: #dee2e6; border-radius: 0 0 0.375rem 0.375rem; }
        .builder-block { transition: all 0.2s ease-in-out; }
        .builder-block:hover { border-color: #ffc107 !important; }
    </style>
    @endpush
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <button class="btn btn-outline-primary" onclick="refreshTestDashboardData(captureTomSelectPreservation(null))">
        ...
        <ul class="nav nav-pills mb-4 shadow-sm p-2 bg-white rounded" id="dashboardTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="questions-tab" data-bs-toggle="tab" data-bs-target="#questions" type="button" role="tab">Questions & Bank</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="dashboardTabContent">
            ...
            <x-test-dashboard.modules-tab :tests="$tests" />
            ...
            RW_JSON: {
                items: [{
                    ...
                    choices: [
                        ...
                        { label: 'B', content: 'Initial incomplete work influenced later science.', is_correct: true },
