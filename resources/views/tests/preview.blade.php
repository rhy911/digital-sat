<x-layouts.app-progress :user="$user" title="Test Preview">
    @push('styles')
    ...
    <div class="ds-home ds-preview-page">
        <section class="ds-workspace-head" aria-labelledby="test-preview-title">
            ...
            <div class="ds-workspace-actions">
                ...
                <a href="{{ route('take-test') }}" class="ds-button ds-button--primary">
                    Open preview
                </a>
            </div>
        </section>
                ...
                <div class="ds-info-list">
                    ...
                    <div class="ds-info-item">
                        ...
                        <div>
                            ...
                            <p>Practice with any accessibility tools you expect to use during a real testing session.</p>
                        </div>
                    </div>
