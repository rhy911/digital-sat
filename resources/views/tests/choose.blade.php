<x-layouts.app-progress :user="$user" title="Choose Practice">
    @push('styles')
    ...
    <div class="ds-home ds-practice-page">
        <section class="ds-workspace-head" aria-labelledby="choose-practice-title">
            ...
            <div class="ds-workspace-actions">
                <a href="{{ route('home.progress') }}" class="ds-button ds-button--secondary">
                        ...
                        <article class="ds-resume-card">
                            <div class="ds-resume-card__body">
                                ...
                                <div class="ds-resume-card__action-wrapper">
                                    @if($moduleUlid)
                                        <a href="{{ route('take-test', ['ulid' => $moduleUlid]) }}?attempt={{ $attempt->ulid }}" class="ds-button ds-button--primary ds-resume-card__button">
                                            Resume Practice
