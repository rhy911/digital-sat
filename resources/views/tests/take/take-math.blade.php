            ...
            <div class="question @if(!$loop->first) d-none @endif" 
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="question-body">
                        <div class="stem-text mb-4">{!! Str::markdown($q->stem) !!}</div>
                            ...
                            @if($q->question_type === 'student_produced_response')
                                <div class="answer-input-container">
                                    ...
                                    <input type="text" class="form-control spr-input" 
                                           ...
                                           maxlength="6">
                                    @if($q->spr_hint)
                                        <div class="form-text mt-1 italic text-muted small">{{ $q->spr_hint }}</div>
                                    @endif

                                    <h4 class="spr-preview mt-4">Answer Preview: <span class="preview-value"></span></h4>
                                </div>
                            @else
