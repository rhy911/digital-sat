<div id="review-section" class="review-section d-none">
    ...
    <div class="question-navigation-box">
        ...
        <div class="question-nav-row row text-center">
        ...
        <div class="d-flex flex-wrap gap-4 justify-content-start py-4" style="min-height: 100px;">
