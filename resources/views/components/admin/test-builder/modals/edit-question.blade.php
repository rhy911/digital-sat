    ...
    <div class="relative min-h-[500px] edit-question-modal">
        ...
        <form id="editQuestionForm" class="m-0">
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="editQuestionType" class="block text-xs font-bold text-slate-700 mb-1.5">Question
                                Type</label>
                            <select
                                class="w-full px-3 py-2 text-sm text-slate-900 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600"
                    ...
                    <div class="border-t border-slate-200 pt-4">
                                ...
                                <div class="grid grid-cols-12 gap-3 items-center">
                                    ...
                                    <div class="col-span-3 pl-2">
                                        <label
                                            ...
                                            <input
                                                class="w-4 h-4 text-indigo-600 border-slate-300 bg-white focus:ring-indigo-500 focus:ring-2 edit-choice-radio"
                        ...
                        <div id="editSprAnswersContainer" class="hidden">
                            <h6 class="text-sm font-bold text-slate-900 flex items-center gap-2 mb-3">
                                <i class="bi bi-check-circle text-indigo-600"></i> Correct answers (SPR)
                            </h6>
                            <div>
                    ...
                    <div class="border-t border-slate-200 pt-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea
                                    class="w-full px-3 py-1.5 text-xs text-slate-900 bg-white border border-slate-300 rounded-lg placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600"
                    ...
                    <div class="border-t border-slate-200 pt-4" id="editMediaManagementContainer">
                        <div class="flex justify-between items-center mb-3">
                            <h6 class="text-sm font-bold text-slate-900 flex items-center gap-2 mb-0">
                                <i class="bi bi-image text-indigo-600"></i> Media management
                            </h6>
                            <button type="button"
                        ...
                        <p class="text-slate-600 text-[11px] flex items-center gap-1.5 mt-2.5 mb-0">
                            <i class="bi bi-info-circle text-indigo-600"></i> Media is managed via
            ...
            <div class="flex justify-end gap-2 mt-6 pt-4 border-t border-slate-200 edit-question-footer">
                ...
                <button type="submit"
                    class="px-5 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm rounded-lg">Update
                    Question</button>
            </div>
        </form>
    </div>
