...
@php
    ...
    $navItems = [
        [
            'label' => 'Progress',
            'href' => route('home.progress'),
            'active' => request()->routeIs('home.progress', 'my-practice', 'my-practice.score', 'submit-status'),
            'current' => request()->routeIs('home.progress'),
        ],
        [
            'label' => 'Practice',
            'href' => route('home.practice'),
            'active' => request()->routeIs('home.practice', 'test.preview', 'take-test', 'test.attempt-options'),
...
<header class="ds-topbar">
    <div class="ds-topbar__inner">
        <x-brand.wordmark href="{{ route('home.progress') }}" size="md" tone="dark" label="DigiSAT progress home" />
