        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                ...
                <div
                    ...
                    class="pointer-events-auto {{ $width }} bg-slate-900 border-l border-slate-800 flex flex-col shadow-2xl h-full"
                >
                    <!-- Header -->
                    <div class="border-b border-slate-800/80 bg-slate-950/40 px-8 py-5 flex items-center justify-between shrink-0">
                        ...
                        @endif
                        <button type="button" x-on:click="show = false; document.body.classList.remove('overflow-hidden');" class="text-slate-400 hover:text-white hover:bg-slate-800/60 rounded-lg p-1.5 focus:outline-hidden transition-colors">
