...
<div x-show="activeTab === 'sections'" id="sections" role="tabpanel" style="display: none;">
    ...
    <div class="flex mb-6 px-4">
        <div>
            ...
            <p class="text-base text-slate-400 font-medium">Organize your tests into Reading & Writing and Math
                sections.
            </p>
        </div>
    </div>
    ...
    <div class="space-y-8">
            ...
            <div class="rounded-2xl border border-slate-800/60 bg-slate-900/20 shadow-2xl overflow-hidden glass-panel">
                ...
                <form id="sectionForm">
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="sectionTest"
                                    class="text-xs font-extrabold text-slate-400 tracking-wider uppercase mb-2 block">Parent
                                    test <span class="text-rose-500">*</span></label>
                                <select
                                    class="form-select tom-select bg-slate-900/60 border border-slate-800/80 text-white rounded-xl"
                            ...
                            <div>
                                <label for="sectionType"
                                    class="text-xs font-extrabold text-slate-400 tracking-wider uppercase mb-2 block">Section
                                    type <span class="text-rose-500">*</span></label>
                                <select
                                    class="w-full px-4 py-2.5 rounded-xl border border-slate-800/80 bg-slate-900/60 text-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none appearance-none bg-no-repeat bg-position-[right_1rem_center] bg-size-[1em_1em] text-sm"
                        ...
                        <div
                            class="bg-amber-500/5 border border-amber-500/15 rounded-xl p-5 flex gap-4 items-start shadow-xl">
                            <div
                            ...
                            <div>
                                <h6 class="text-xs font-extrabold text-amber-400 uppercase tracking-wider mb-1">
                                    Standardized SAT Structure</h6>
                                <p class="text-xs text-amber-400/90 leading-relaxed mb-0 font-medium">
                                    Section order is fixed for Digital SAT: <strong
                                        class="text-amber-400 font-bold">Reading & Writing</strong> (order 1), <strong
                                        class="text-amber-400 font-bold">Math</strong> (order 2). You can only add one
                                    section of each type per test.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="px-6 py-4 bg-slate-950/40 border-t border-slate-800/80 flex justify-end">
                        ...
                        <button type="submit"
                            class="px-8 py-3 bg-linear-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-extrabold rounded-xl shadow-lg shadow-emerald-600/20 hover:shadow-emerald-600/35 transform flex items-center gap-2.5 text-xs uppercase tracking-wider">
        ...
        <div id="sectionsEmptyState"
            class="rounded-2xl border border-slate-800/60 bg-slate-900/20 shadow-2xl overflow-hidden {{ $hasSections ? 'hidden' : '' }} glass-panel">
            <div class="p-16 text-center">
                ...
                <p class="text-slate-400 mb-8 max-w-sm mx-auto text-sm leading-relaxed">Create a section within your
                    test to hold modules and questions.</p>
                <button type="button"
                    ...
                    onclick="document.getElementById('sectionTest').focus();">
        ...
        <div id="sectionsTableContainer"
            ...
            <div
                ...
                <div class="relative">
                    ...
                    <input type="text"
                        class="pl-9 pr-4 py-2.5 w-full md:w-72 text-sm rounded-xl border border-slate-800/80 bg-slate-900/60 text-white placeholder-slate-400 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none"
