...
<div x-show="activeTab === 'tests'" id="tests" role="tabpanel" style="display: none;">
    ...
    <div class="flex mb-6 px-4">
        <div>
            <h3 class="text-xl font-extrabold text-white tracking-tight">Tests</h3>
    ...
    <div class="space-y-8">
        ...
        <div>
            <div
                class="w-full mx-auto max-w-4xl rounded-2xl border border-slate-800/60 bg-slate-900/20 shadow-2xl overflow-hidden glass-panel">
                ...
                <form id="testForm">
                    ...
                    <div class="px-6 py-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
                            ...
                            <div class="md:col-span-1.5 col-span-3">
                                ...
                                <div class="relative">
                                    <input type="number"
                                        class="w-full pl-4 pr-12 py-2.5 rounded-xl border border-slate-800/80 bg-slate-900/60 text-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none"
                                        id="breakDuration" name="break_duration_minutes" value="10" required>
                                    <span
                                        class="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none"><i
                    ...
                    <div class="px-6 py-4 bg-slate-950/40 border-t border-slate-800/80 flex justify-end">
                        <button type="submit"
                            class="px-8 py-3 bg-linear-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white font-extrabold rounded-xl shadow-lg shadow-indigo-600/25 hover:shadow-indigo-600/40 transform flex items-center gap-2.5 text-xs uppercase tracking-wider">
        ...
        <div id="testsEmptyState"
            class="rounded-2xl border border-slate-800/60 bg-slate-900/20 shadow-2xl overflow-hidden {{ $tests->isEmpty() ? '' : 'hidden' }} glass-panel">
            <div class="p-16 text-center">
                ...
                <button type="button"
                    ...
                    onclick="document.getElementById('testTitle').focus();">
