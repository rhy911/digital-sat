            ...
            <article class="ds-card ds-practice-library">
                <div class="ds-card__header">
                    ...
                    @if($completedTests->isNotEmpty())
                        <span class="ds-card-note">{{ $completedTests->count() }} {{ \Illuminate\Support\Str::plural('test', $completedTests->count()) }}</span>
                    @endif
                </div>
                ...
                @else
                    <div class="ds-empty ds-empty--compact">
                        ...
                        <p>Complete a full-length practice test to see your score report, domain breakdown, and correct answers.</p>
                        <div style="margin-top: 1.25rem;">
                            <a href="{{ route('home.practice') }}" class="ds-button ds-button--primary" style="display: inline-flex;">
