    ...
    <div class="md:container md:mx-auto px-4">
        ...
        <section>
            ...
            <div class=" flex gap-4" id="practice-active">
                <x-student.dashboard.practice-option-link :href="route('test.preview')" :image="asset('images/test_preview.png')" alt="Test Preview"
                    title="Test Preview" />
                <x-student.dashboard.practice-option-link :href="route('home.practice')" :image="asset('images/test.png')" alt="Full-Length Practice"
                ...
                @empty
                    @if ($inProgressTests->isEmpty())
                        <x-student.cards.empty-state-box title="Ready to Practice?">
                            <p class="text-lg">Go to <strong>Active</strong> and select <strong>Full-Length
                                    Practice</strong>.
                            </p>
                            <p class="text-lg">Once you take any full-length practice test, it will appear here with
                                your scores
                                and
                                feedback.</p>
                        </x-student.cards.empty-state-box>
