<x-layouts.app :user="$user">
    ...
    <div class="welcome">
        <div class="md:container md:mx-auto px-4 pb-6">
            <h1 class="text-3xl md:text-4xl font-normal text-[#324dc7]">Welcome, {{ $user->username ?? 'User' }}! Good luck on test day!</h1>
        </div>
    </div>
    <div class="md:container md:mx-auto px-4">
        <section class="your-tests">
            ...
            <x-home.empty-state-box title="You Have No Upcoming Tests" id="active-tests">
                <p class="text-lg">Tests appear here a few weeks before test day. <strong>If you got a paper ticket from your school, <a class="text-[#324dc7] underline"
            ...
            <div class="practice-options flex gap-4 hidden" id="practice-past">
                ...
                @empty
                    <x-home.empty-state-box title="Ready to Practice?" class="w-full">
                        <p class="text-lg">Go to <strong>Active</strong> and select <strong>Full-Length Practice</strong>.</p>
                        <p class="text-lg">Once you take any full-length practice test, it will appear here with your scores and
                            feedback.</p>
                    </x-home.empty-state-box>
                @endforelse
            </div>
