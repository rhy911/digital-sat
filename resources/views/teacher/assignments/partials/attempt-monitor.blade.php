                ...
                <div class="attempt-monitor__summary">
                    ...
                    <dl class="attempt-monitor__metrics">
                        ...
                        <div>
                            ...
                            <dd><span class="font-semibold text-indigo-600">{{ ucfirst($attempt->rw_m2_path) }}</span></dd>
                        </div>
                        @endif
                        @if ($attempt->math_m2_path)
                        <div>
                            <dt>Math Module 2 Path</dt>
                            <dd><span class="font-semibold text-indigo-600">{{ ucfirst($attempt->math_m2_path) }}</span></dd>
                        </div>
                        @endif
                    </dl>
                                                        ...
                                                        <button type="button" 
                                                            ...
                                                            <div class="flex items-center gap-3 min-w-0 flex-1">
                                                                <span class="attempt-monitor__question-number shrink-0 font-medium"
                                                                    :class="selectedAnswerId === {{ $answer->id }} ? 'bg-indigo-600 text-white' : ''">
                                                                    {{ $loop->iteration }}
                                                                </span>
                                                            ...
                                                            <div class="flex items-center gap-2 shrink-0 ml-3">
                                                                <svg x-show="loading && selectedAnswerId === {{ $answer->id }}" class="animate-spin h-4 w-4 text-indigo-600" fill="none" viewBox="0 0 24 24">
