<div class="attempt-monitor" x-data="{ activeAttempt: {{ $initialAttempt->id }} }" data-attempt-monitor
    ...
    <div class="attempt-monitor__panels">
        @foreach ($row['attempts'] as $attempt)
            ...
            <section class="attempt-monitor__panel" id="{{ $attemptModalId }}-panel-{{ $attempt->id }}"
                ...
                x-show="activeAttempt === {{ $attempt->id }}" x-cloak>
                        ...
                        <div>
                            ...
                            <dd>
                                ...
                                @elseif($attempt->total_score !== null)
                                    {{ $attempt->total_score }}@else&mdash;
                                @endif
                            </dd>
                        </div>
                    </dl>
                ...
                <div class="attempt-monitor__responses">
                    <div class="attempt-monitor__responses-heading">
                        ...
                        <span>{{ $savedResponses }}
                            {{ \Illuminate\Support\Str::plural('question', $savedResponses) }}</span>
                    </div>
